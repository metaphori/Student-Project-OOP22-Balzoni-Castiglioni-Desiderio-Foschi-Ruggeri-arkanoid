...
\\All'interno della classe astratta viene tenuta traccia:
\begin{itemize}
...
\subsection{Desiderio Edoardo}
\begin{itemize}
    \item Ispirato dalla programmazione funzionale ho cercato di evitare il piú possibile la scrittura di swtch
          statement all'interno del progetto, in questo stnippet\footnote{\url{https://pastecode.io/s/18uxzd1a}} ho cercato
